...
export default function AuthPage() {
  ...
  return (
    ...
    >
          ...
          >
            ...
            <div
              style={{
                ...
                pointerEvents: "none",
                background:
                  "linear-gradient(145deg, rgba(13, 122, 95, 0.08) 0%, transparent 55%)",
              }}
            />
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              >
                <div
                  style={{
                    ...
                    fontSize: 14,
                    color: "white",
                    boxShadow: "0 0 18px rgba(13, 122, 95, 0.35)",
                  }}
                >
                  J
                </div>
              ...
              >
                ...
                <span
                  style={{
                    background:
                      "linear-gradient(90deg, var(--color-primary), #34D399, var(--color-primary))",
              ...
              >
                The unified real estate & land management platform for
                Philippine developers, brokers, and landlords.
              </p>
              ...
              >
                {[
                  "Land parcels & project tracking with GPS",
                  "Tamper-evident title vault (TCT / Tax Decs)",
                  "Licensed broker & agent contact registry",
                  "Philippine BIR property tax deadline alerts",
                ].map((f, i) => (
                  <div
                    key={i}
            ...
            >
              ...
              />
              <span style={{ fontSize: 11, color: "#9490B5" }}>
          ...
          >
                ...
                {(["login", "signup"] as const).map((m) => (
                  <button
                    ...
                    style={{
                      ...
                      boxShadow:
                        mode === m
                          ? "0 2px 10px rgba(13, 122, 95, 0.35)"
                          : "none",
                    }}
                  >
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <p style={{ fontSize: 13, color: "#9490B5", lineHeight: 1.55 }}>
                {mode === "login"
                  ? "Access your property portfolio and title records."
                  : mode === "signup"
                    ? "Create your account to manage properties, titles, and agents."
                    : email
            ...
            {resetSentTo ? (
              ...
              >
                ...
                <p
                  style={{ fontWeight: 600, marginBottom: 5, color: "#F0EEFF" }}
                >
                  Reset email sent
                </p>
                <p style={{ fontSize: 12, color: "#9490B5", lineHeight: 1.55 }}>
                  We sent a setup link to {resetSentTo}. Make sure this is your
                  email, then open the link to create a new password.
                </p>
                <button
                  type="button"
              ...
              >
                      ...
                      <div style={{ marginTop: 7 }}>
                        <div style={{ display: "flex", gap: 4 }}>
                          {[0, 1, 2, 3].map((i) => {
                            ...
                            const visualScore = password
                              ? Math.max(1, passwordScore)
                              : 0;
                            return (
                              <div
                                key={i}
                ...
                <button
                  ...
                  style={{
                    ...
                    boxShadow: loading
                      ? "none"
                      : `0 4px 18px rgba(13, 122, 95, 0.35), 0 0 0 1px rgba(255,255,255,0.06)`,
                    transition: "all 0.18s",
                  }}
                  onMouseEnter={(e) => {
                    if (!loading) {
                      e.currentTarget.style.transform = "translateY(-1px)";
                      e.currentTarget.style.boxShadow = `0 6px 24px rgba(16, 185, 129, 0.45), 0 0 0 1px rgba(255,255,255,0.1)`;
                    }
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.transform = "translateY(0)";
                    e.currentTarget.style.boxShadow = `0 4px 18px rgba(13, 122, 95, 0.35), 0 0 0 1px rgba(255,255,255,0.06)`;
                  }}
                >
                  {loading ? (
                    <>
            ...
            {mode === "recovery" ? (
              ...
              <>
                ...
                <button
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.borderColor = "#4A4670";
      ...
      >
        <span style={{ fontSize: 11, color: "#5A5680" }}>
          © {new Date().getFullYear()} JuanProperty
        </span>
        <div style={{ display: "flex", gap: 18 }}>
          {["Privacy", "Terms", "Docs"].map((l) => (
            <Link
              ...
              onMouseLeave={(e) => (e.currentTarget.style.color = "#5A5680")}
            >
              {l}
            </Link>
          ))}
